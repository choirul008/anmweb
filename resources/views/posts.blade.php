...
<div class="row justify-content-center mb-3">
    ...
    @if ($posts->count())
        ...
        <div style="max-height: 350px; overflow:hidden">
            ...
            @else
                <img src="https://source.unsplash.com/1200x250?{{ $posts[0]->category }}" class="card-img-top" alt="{{ $posts[0]->category->name }}">
        @endif
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    ...
                    @if ($posts[0]->image)
        <div style="max-height: 350px; overflow:hidden">
            <img src="{{ asset('storage/' . $posts[0]->image) }}" alt="{{ $posts[0]->author->username }}" class="img-fluid">
        </div>
            @else
                <img src="https://source.unsplash.com/1200x250?{{ $posts[0]->category }}" class="card-img-top" alt="{{ $posts[0]->category->name }}">
        @endif
    ...
    @else
        ...
        <h3><a href="/posts" class="justify-content-center" class="text-decoration-none" >Back</a></h3>
    @endif
